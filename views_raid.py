...
# optional (wenn vorhanden): raidlist update nach votes/finish
try:
    from raidlist import schedule_raidlist_refresh
except Exception:
    schedule_raidlist_refresh = None
...
class RaidFinishButton(Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        async with await get_session() as session:
            ...
            # delete participant list messages + cleanup role + delete raid data
        ...
        # debounced raidlist refresh (if available)
        if schedule_raidlist_refresh and interaction.guild:
...
class RaidVoteView(View):
    ...
    async def _refresh_message(self, interaction: discord.Interaction):
        ...
        async with await get_session() as session:
            ...
            # create/update participant list messages per (day,time) slot when threshold met
    ...
    # ✅ REQUIRED METHODS (fix for your AttributeError)
